...
?>
        ...
        <div class="flex-1 flex items-center justify-center p-8">
            <div class="bg-gray-100 shadow-lg rounded-lg w-full text-center p-6">
                ...
                <form action="mailto:kingwagla@gmail.com" method="POST" class="space-y-6">
                    <div>
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="4" required
                            class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-amber-400"></textarea>
                    </div>
