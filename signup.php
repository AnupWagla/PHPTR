...
<form action="signuphandle.php" method="post" class="bg-white p-6 rounded shadow-md w-80">
...
<input type="email" id="email" name="email" required
    class="w-full border border-gray-300 p-2 rounded mb-4">
        ...
        <p class=" text-center flex justify-center">Have a account?<a class=" text-blue-600 hover:to-blue-700" href="login.php">Login</a>
        </p>
    </form>
