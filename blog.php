...
<div class="flex-1 text-center p-8">
    <h1 class="text-4xl font-bold mb-6">Navigating the AI Frontier: Public and Expert Opinions on Recent Developments</h1>

    <div class="text-left">
        <h2 class="text-2xl font-semibold mb-4">Introduction</h2>

        <p class="mb-6 ">
            Artificial intelligence (AI) is reshaping industries, economies, and societies at an unprecedented pace.
            ...
            media, and sustainability, reflecting the complex interplay between AI's promise and its challenges.
        </p>

        <h3 class="text-xl font-semibold mb-4">1. EU AI Act: Delayed Guidance Amidst Enforcement</h3>

        <p class="mb-6 text-gray-700 ">
            The European Union's AI Act, a pioneering effort to regulate AI, has faced a significant setback with the
        ...
        <div class="mb-6">
            <p class="mb-4 text-gray-700 ">
                <strong>Business Concerns:</strong> Over 40 European CEOs, including those from Airbus, ASML, and Mistral, have urged a
            ...
            <p class="mb-4 text-gray-700 ">
                <strong>Political Perspectives:</strong> Swedish Prime Minister Ulf Kristersson has labeled the AI Act "confusing,"
            ...
            <p class="mb-4 text-gray-700 ">
                <strong>Public and Expert Discourse:</strong> On X, users like @typewriters argue that the AI Act's demands are subjective
        ...
        <p class="mb-8 text-gray-700 ">
            ...
            debating whether the Act will foster responsible AI or stifle innovation.
        </p>

        <h2 class="text-2xl font-semibold mb-4">2. AI and Job Displacement: A Looming Socio-Economic Challenge</h2>
        
        <p class="mb-6 text-gray-700 ">
            CEOs from diverse sectors have raised alarms about AI's potential to displace white-collar jobs, sparking
            widespread concern about socio-economic impacts:
        </p>

        <div class="mb-6">
            <p class="mb-4 text-gray-700 ">
                <strong>CEO Predictions:</strong><br>
        ...
        <div class="mb-6">
            <p class="mb-4 text-gray-700 ">
                <strong>Public and Social Media Reactions:</strong>
            </p>
        ...
        <p class="mb-8 text-gray-700 ">
            ...
            displacement, income inequality, and educational misalignment.
        </p>
    </div>
</div>
